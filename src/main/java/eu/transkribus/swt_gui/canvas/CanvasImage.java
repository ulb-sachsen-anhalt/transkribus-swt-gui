...
final public class CanvasImage {
	...
	public CanvasImage(URL url) throws Exception {
		...
		try {
			...
			logger.debug("Read image metadata: original width = {}, original height = {}, destination width = {}, destination height = {}, orientation = {}", 
					transformation.getOriginalWidth(), transformation.getOriginalHeight(), 
					transformation.getDestinationWidth(), transformation.getDestinationHeight(), 
