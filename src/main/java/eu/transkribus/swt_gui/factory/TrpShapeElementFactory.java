...
//		}
	 ...
	 */
	public ITrpShapeType createTextRegionFromShape(ICanvasShape shape, TrpPageType parent) throws NoParentRegionException, NoParentLineException, BaselineExistsException, CanvasException {
		if (Storage.getInstance().getTranscript()==null)
...
//			int[] corners = PointStrUtils.parseCornerPts(tc.getCoords().getCornerPts());
	...
	public List<ICanvasShape> addAllCanvasShapes(ITrpShapeType trpShape) {
		...
		// add shape for all sub elements:
