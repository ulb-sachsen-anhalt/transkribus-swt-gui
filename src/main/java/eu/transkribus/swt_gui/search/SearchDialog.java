...
public class SearchDialog extends Dialog {
	...
	TagSearchComposite tagSearchComposite;
...
//		c.setLayout(new FillLayout());
		...
		tagSearchComposite = new TagSearchComposite(tabFolder, 0);
		tagSearchComposite.setLayoutData(new GridData(GridData.FILL_BOTH));
		tagsItem = createCTabItem(tabFolder, tagSearchComposite, "Tags");
...
//		textAndTagsItem = createCTabItem(tabFolder, tsc, "Text / Tags");
	...
	public TagSearchComposite getTagSearchComposite() {
		return tagSearchComposite;
	}
