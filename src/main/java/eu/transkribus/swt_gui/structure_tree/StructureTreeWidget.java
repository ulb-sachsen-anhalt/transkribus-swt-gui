...
public class StructureTreeWidget extends Composite {
	...
	public final static ColConfig TYPE_COL = new ColConfig("Type", 120, "");
	public final static ColConfig TEXT_COL = new ColConfig("Text", 320, "");
	// public final static ColConfig ID_COL = new ColConfig("ID", 65, "");
	public final static ColConfig COORDS_COL = new ColConfig("Coords", 80, "");
	...
	public final static ColConfig[] COLUMNS = new ColConfig[] { 
		TYPE_COL, TEXT_COL, COORDS_COL /*STRUCTURE_TYPE_COL, READING_ORDER_COL, ID_COL, OTHER_COL*/ 
	};
