...
public class SettingsDialog extends Dialog {
	...
	private Button separatorsColorButton;
	...
	private void addBindings() {
		...
		DataBinder.get().bindColorToButton(TrpSettings.COLOR_SEPARATORS_PROPERTY, trpSets, this.separatorsColorButton);
	}
...
//		wordsColorButton.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
		...
		Label sepColorLabel = new Label(shell, SWT.NONE);
		sepColorLabel.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 1, 1));
		sepColorLabel.setText("Separator color");
		
		separatorsColorButton = new Button(shell, SWT.NONE);
		separatorsColorButton.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 1, 1));
