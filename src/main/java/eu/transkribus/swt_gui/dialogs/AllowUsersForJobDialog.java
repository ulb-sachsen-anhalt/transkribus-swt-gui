...
public class AllowUsersForJobDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		jobImplCombo.getCombo().add(JobImpl.CITlabHtrPlusTrainingJobLarge.toString());
		jobImplCombo.getCombo().add(JobImpl.PyLaiaTrainingJobLarge.toString());
		jobImplCombo.getCombo().add(JobImpl.BaselineTrainingJob.toString());
		jobImplCombo.getCombo().add(JobImpl.PyLaiaKwsDecodingJob.toString());
